...
public class ContainerKafkaTest {
    ...
    static class KafkaTestContainersConfiguration {
        ...
        public ConsumerFactory<String, Order> consumerTestFactory() {
            ...
            props.put(ConsumerConfig.GROUP_ID_CONFIG, "test-courier");
        ...
        public ConsumerFactory<String, Order> consumerFactory() {
            ...
            props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafka.getBootstrapServers());
            props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
            props.put(ConsumerConfig.GROUP_ID_CONFIG, "courier");
            return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(Order.class));
        }
    ...
    public void TestConsumer() throws InterruptedException {
        testProducer.send(TestData.ORDER_READY);
        testConsumer.getLatch().await(10000, TimeUnit.MILLISECONDS);// wait for 10 sec
        assertThat(testConsumer.getLatch().getCount(), equalTo(0L));
        assertThat(testConsumer.getOrders(), hasItem(TestData.ORDER_DELIVER));
    }
}
